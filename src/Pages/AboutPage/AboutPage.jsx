      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        <article className="bg-white p-8 rounded-lg shadow-lg flex flex-col gap-y-6">
          <p className="text-lg leading-relaxed text-gray-700">
            ...
            <Link to={`/${currentLang}/flights`} className="text-blue-500 hover:underline"> flights</Link>,
            <Link to={`/${currentLang}/hotels`} className="text-blue-500 hover:underline"> hotels</Link>,
            <Link to={`/${currentLang}/cities`} className="text-blue-500 hover:underline"> city tours</Link>,
            <Link to={`/${currentLang}/vacations`} className="text-blue-500 hover:underline"> vacations</Link>, and
            <Link to={`/${currentLang}/cruises`} className="text-blue-500 hover:underline"> cruises</Link>, so you can create a customized itinerary that suits your needs and budget.
          </p>
          <p className="text-lg leading-relaxed text-gray-700">
