...
// import { fetchHotelAsyncApiId, fetchHotelByIdAsync } from '../../Store/Slices/fetchHotelSliceAsync'
...
// const HotelDetailsApiPage = () => {
//     const { id } = useParams()
//     const dispatch = useDispatch()
//     const loading = useSelector(state => state.hotels.loading)
//     const hotel = useSelector(state => state.hotels.hotelApi)
//     const user = useSelector(state => state.session.user)
//    

//     useEffect(() => {
//         if (id) {
//             dispatch(fetchHotelAsyncApiId({ hotelId: id }))
//         }
//     }, [dispatch, id])
...
// export default HotelDetailsApiPage
