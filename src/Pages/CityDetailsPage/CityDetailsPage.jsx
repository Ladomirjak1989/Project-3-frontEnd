...
const CityDetailsPage = () => {
  ...
  const city = useSelector(state => Object.values(state.city.cities))
    ...
    <div className="bg-gray-100 min-h-screen pb-12">
      ...
      <div className="container mx-auto pt-5">
        <div className="max-w-lg mx-auto flex flex-col items-center bg-gray-200 p-5 rounded-md gap-5">
          <img src={imgURL} alt={city.name} className="max-w-full w-full" />
          ...
          <div className="flex justify-center gap-5 mt-5">
            <Link className="bg-gray-400 text-black py-2 px-4 rounded hover:bg-gray-500" to={`/cities/${city.name}/flights`}>
              Show flights
            </Link>
          </div>
        </div>
