      ...
      <div className="w-full max-w-4xl bg-opacity-80 rounded-lg p-6">
        ...
        {weatherData && (
          <div className="mt-8">
            ...
            {/* Hourly forecast
            <div className="mt-4">
              <h3 className="text-2xl font-semibold text-gray-800 mb-4">Hourly weather forecast for the current day </h3>
              <Swiper
                spaceBetween={16}
                slidesPerView={2}
                navigation={true}
              ...
              >
                {weatherData.forecast.forecastday[0].hour
                  .filter((item) => {
                    ...
                    const weatherDay = new Date(item.time);
                    return toDay < weatherDay;
                  })
                  .map((item) => (
                    <SwiperSlide key={item.time}>
                      <div className="flex min-h-[220px] flex-col items-center bg-gray-100 p-4 rounded-lg shadow-sm">
                        ...
                        <img
                          ...
                          className="w-14 h-14 my-2"
                        />
                        <span className="text-sm text-gray-600">{item.condition.text}</span>
                      </div>
                    </SwiperSlide>
                  ))}
              </Swiper>
