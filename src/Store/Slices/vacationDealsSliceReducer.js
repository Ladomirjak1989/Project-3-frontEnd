...
const vacationDealsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchVacationDealsAsync.pending, (state) => {
        state.loading = true
        state.error = null
      })
      .addCase(fetchVacationDealsAsync.fulfilled, (state, action) => {
        state.loading = false

        state.deals = action.payload
      })
      .addCase(fetchVacationDealsAsync.rejected, (state, action) => {
        state.loading = false
